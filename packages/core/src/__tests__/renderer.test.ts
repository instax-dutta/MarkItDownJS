...
import type {
  DocumentNode, HeadingNode, ParagraphNode, TextNode,
  TableNode, TableRowNode, TableCellNode, ListNode, ListItemNode,
  LinkNode, ImageNode, CodeNode, StrongNode, EmphasisNode,
